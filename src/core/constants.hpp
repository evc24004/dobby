...
inline constexpr char kMinecraftVersion[] = "1.26.44.3";
inline constexpr char kMinecraftBuildId[] = "b480c79a54f33d6e4f0d63a131673e3daf749911";
...
inline constexpr std::uintptr_t kViolationGetIdOffset = 0x0cfa7074;
inline constexpr std::uintptr_t kViolationGetIdVtableSlotOffset = 0x121026f8;
inline constexpr std::array<std::uint8_t, 8> kViolationGetIdSignature{
        0x80, 0x13, 0x80, 0x52, 0xc0, 0x03, 0x5f, 0xd6};

inline constexpr std::uintptr_t kStreamReadOffset = 0x11a86404;
inline constexpr std::uintptr_t kStreamReadVtableSlotOffset = 0x124a9080;
...
inline constexpr std::uintptr_t kPacketEndCheckOffset = 0x11a86174;
...
inline constexpr std::uintptr_t kSchemaPushMemberOffset = 0x0cbd0bd0;
inline constexpr std::uintptr_t kSchemaPushMemberVtableSlotOffset = 0x120e7c78;
inline constexpr std::array<std::uint8_t, 8> kSchemaPushMemberSignature{
        0x20, 0x00, 0x80, 0x52, 0xc0, 0x03, 0x5f, 0xd6};

inline constexpr std::uintptr_t kSchemaPushElementOffset = 0x0cbd0be4;
inline constexpr std::uintptr_t kSchemaPushElementVtableSlotOffset = 0x120e7c88;
inline constexpr std::array<std::uint8_t, 4> kSchemaPushElementSignature{
        0xc0, 0x03, 0x5f, 0xd6};

inline constexpr std::uintptr_t kSchemaPopOffset = 0x0cbd0be8;
inline constexpr std::uintptr_t kSchemaPopVtableSlotOffset = 0x120e7c90;
...
inline constexpr std::uintptr_t kActorRenderOffset = 0x0a318470;
...
inline constexpr std::uintptr_t kChunkCoordinatorOnChunkLoadedOffset = 0x0a16a3c0;
inline constexpr std::uintptr_t kChunkCoordinatorOnChunkLoadedSlotOffset = 0x11f57278;
...
inline constexpr std::uintptr_t kChunkCoordinatorOnSubChunkLoadedOffset = 0x0a16a928;
inline constexpr std::uintptr_t kChunkCoordinatorOnSubChunkLoadedSlotOffset = 0x11f57288;
...
inline constexpr std::uintptr_t kChunkCoordinatorOnChunkUnloadedOffset = 0x088d7ff4;
inline constexpr std::uintptr_t kChunkCoordinatorOnChunkUnloadedSlotOffset = 0x11f57290;
...
inline constexpr std::uintptr_t kChestBlockActorConstructorOffset = 0x0fd83930;
...
inline constexpr std::uintptr_t kChestBlockActorFactoryOffset = 0x0fd83b54;
...
inline constexpr std::uintptr_t kChestBlockActorVtableOffset = 0x1237cb18;
inline constexpr std::uintptr_t kChestBlockActorDestructorOffset = 0x0fd83a20;
inline constexpr std::array<std::uint8_t, 16> kChestBlockActorDestructorSignature{
        0xfd, 0x7b, 0xbd, 0xa9, 0xf6, 0x57, 0x01, 0xa9,
        0xf4, 0x4f, 0x02, 0xa9, 0xfd, 0x03, 0x00, 0x91};
inline constexpr std::uintptr_t kChestBlockActorDeletingDestructorOffset = 0x0fd83b08;
...
inline constexpr std::uintptr_t kBlockActorPositionLayoutProbeOffset = 0x0fdb1a3c;
...
inline constexpr std::uintptr_t kSubChunkAbsoluteIndexAccessorOffset = 0x0f99f1e4;
inline constexpr std::array<std::uint8_t, 8> kSubChunkAbsoluteIndexAccessorSignature{
        0x00, 0x84, 0x41, 0x39, 0xc0, 0x03, 0x5f, 0xd6};
inline constexpr std::uintptr_t kSubChunkStorageLayoutProbeOffset = 0x0f99f214;
...
inline constexpr std::uintptr_t kBlockTypeGetHashedNameOffset = 0x0f339194;
...
inline constexpr std::uintptr_t kHashedStringGetValueOffset = 0x11aaf4e4;
...
inline constexpr std::array<SubChunkStorageDispatch, 9>
        kSubChunkStorageDispatches{{
                {0x123536d8, 0x0f9b479c, 0x0f9b4d68, 0x0f9b4d74,
                 0x0f9b4d7c, 0},
                {0x123537e0, 0x0f9b5154, 0x0f9b731c, 0x0f9b732c,
                 0x0f9b7334, 1},
                {0x123538c0, 0x0f9b77a8, 0x0f9b9d80, 0x0f9b9d90,
                 0x0f9b9d98, 2},
                {0x123539a0, 0x0f9ba1e4, 0x0f9bd318, 0x0f9bd328,
                 0x0f9bd330, 3},
                {0x12353a80, 0x0f9bd764, 0x0f9bf8c4, 0x0f9bf8d4,
                 0x0f9bf8dc, 4},
                {0x12353b60, 0x0f9bfd00, 0x0f9c1c28, 0x0f9c1c38,
                 0x0f9c1c40, 5},
                {0x12353c40, 0x0f9c2040, 0x0f9c4220, 0x0f9c4230,
                 0x0f9c4238, 6},
                {0x12353d20, 0x0f9c4660, 0x0f9c65f0, 0x0f9c6600,
                 0x0f9c6608, 8},
                {0x12353e00, 0x0f9c6a24, 0x0f9c8970, 0x0f9c8980,
                 0x0f9c8988, 16},
        }};
...
inline constexpr std::uintptr_t kActorGetAabbOffset = 0x0ec8cddc;
...
inline constexpr std::uintptr_t kLevelGetRuntimeActorListOffset = 0x0f22cc7c;
...
inline constexpr std::uintptr_t kLevelForEachPlayerOffset = 0x0f22bdb8;
...
inline constexpr std::uintptr_t kLevelGetPrimaryLocalPlayerOffset = 0x0f22b784;
...
inline constexpr std::uintptr_t kClientLevelVtableOffset = 0x11eddfb0;
...
inline constexpr std::uintptr_t kLevelGetCurrentServerTickOffset = 0x09ad99d8;
...
// validation succeed.
inline constexpr std::uintptr_t kRakNetPeerUpdateOffset = 0x0c2c1d40;
inline constexpr std::uintptr_t kRakNetPeerUpdateVtableSlotOffset = 0x120b07d8;
...
inline constexpr std::uintptr_t kPacketObserverVtableOffset = 0x120b0830;
inline constexpr std::uintptr_t kPacketSentToOffset = 0x0c2a4840;
inline constexpr std::uintptr_t kPacketSentToVtableSlotOffset = 0x120b0840;
inline constexpr std::array<std::uint8_t, 16> kPacketSentToSignature{
        0xfd, 0x7b, 0xbe, 0xa9, 0xf3, 0x0b, 0x00, 0xf9,
        0xfd, 0x03, 0x00, 0x91, 0x20, 0x04, 0x00, 0x0f};
inline constexpr std::uintptr_t kPacketReceivedFromOffset = 0x0c2a4884;
inline constexpr std::uintptr_t kPacketReceivedFromVtableSlotOffset = 0x120b0848;
...
inline constexpr std::uintptr_t kPacketFactoryOffset = 0x0c29288c;
...
inline constexpr std::uintptr_t kBinaryStreamConstructorOffset = 0x11a85f5c;
inline constexpr std::array<std::uint8_t, 16> kBinaryStreamConstructorSignature{
        0x08, 0x51, 0x00, 0xd0, 0x08, 0x01, 0x38, 0x91,
        0xe9, 0x03, 0x00, 0xaa, 0x0a, 0x24, 0x00, 0x91};
inline constexpr std::uintptr_t kBinaryStreamVtableOffset = 0x124a7e00;
...
inline constexpr std::array<ProtocolVirtualTarget, 27>
        kBinaryStreamProtocolTargets{{
                {3, 0x11a86ec8, {0x08, 0x00, 0x40, 0xf9, 0x21, 0x00, 0x00, 0x12}},
                {4, 0x11a8702c, {0xff, 0xc3, 0x00, 0xd1, 0xfd, 0x7b, 0x01, 0xa9}},
                {5, 0x11a873c4, {0xff, 0xc3, 0x00, 0xd1, 0xfd, 0x7b, 0x01, 0xa9}},
                {6, 0x11a87af4, {0xff, 0xc3, 0x00, 0xd1, 0xfd, 0x7b, 0x01, 0xa9}},
                {7, 0x11a8775c, {0xff, 0xc3, 0x00, 0xd1, 0xfd, 0x7b, 0x01, 0xa9}},
                {8, 0x11a885c4, {0xff, 0xc3, 0x00, 0xd1, 0xfd, 0x7b, 0x01, 0xa9}},
                {9, 0x11a87e90, {0xff, 0xc3, 0x00, 0xd1, 0xfd, 0x7b, 0x01, 0xa9}},
                {10, 0x11a8822c, {0xff, 0xc3, 0x00, 0xd1, 0xfd, 0x7b, 0x01, 0xa9}},
                {11, 0x11a88cf4, {0xff, 0xc3, 0x00, 0xd1, 0xfd, 0x7b, 0x01, 0xa9}},
                {12, 0x11a8895c, {0xff, 0xc3, 0x00, 0xd1, 0xfd, 0x7b, 0x01, 0xa9}},
                {13, 0x11a89f9c, {0xfd, 0x7b, 0xbd, 0xa9, 0xf5, 0x0b, 0x00, 0xf9}},
                {14, 0x11a8a6fc, {0xfd, 0x7b, 0xbd, 0xa9, 0xf5, 0x0b, 0x00, 0xf9}},
                {15, 0x11a89f84, {0x28, 0x78, 0x1f, 0x53, 0x09, 0x00, 0x40, 0xf9}},
                {16, 0x11a8a75c, {0x28, 0xf8, 0x7f, 0xd3, 0x09, 0x00, 0x40, 0xf9}},
                {17, 0x11a89094, {0xff, 0xc3, 0x00, 0xd1, 0xfd, 0x7b, 0x01, 0xa9}},
                {18, 0x11a8942c, {0xff, 0xc3, 0x00, 0xd1, 0xfd, 0x7b, 0x01, 0xa9}},
                {19, 0x11a8966c, {0x00, 0xc0, 0x22, 0x1e, 0xe3, 0x03, 0x02, 0xaa}},
                {20, 0x11a8968c, {0xe8, 0x67, 0x6a, 0xb2, 0x00, 0xc0, 0x22, 0x1e}},
                {21, 0x11a8c0d4, {0xfd, 0x7b, 0xbd, 0xa9, 0xf5, 0x0b, 0x00, 0xf9}},
                {22, 0x11a8c198, {0xe8, 0x03, 0x00, 0xaa, 0x81, 0x00, 0x00, 0x37}},
                {23, 0x11a8c1bc, {0x48, 0x04, 0x40, 0xf9, 0xe1, 0x03, 0x00, 0xaa}},
                {24, 0x11a8c214, {0xff, 0xc3, 0x00, 0xd1, 0xfd, 0x7b, 0x01, 0xa9}},
                {25, 0x11a8c28c, {0xff, 0xc3, 0x00, 0xd1, 0xfd, 0x7b, 0x01, 0xa9}},
                {26, 0x11a9ebbc, {0xe0, 0x03, 0x1f, 0x2a, 0xc0, 0x03, 0x5f, 0xd6}},
                {27, 0x11a9ebc4, {0xc0, 0x03, 0x5f, 0xd6, 0xc0, 0x03, 0x5f, 0xd6}},
                {28, 0x11a9ebc8, {0xc0, 0x03, 0x5f, 0xd6, 0x08, 0x20, 0x40, 0x39}},
                {29, 0x11a8c3ac, {0xfd, 0x7b, 0xbe, 0xa9, 0xf4, 0x4f, 0x01, 0xa9}},
        }};

inline constexpr std::uintptr_t kPacketSchemaWriterVtableOffset = 0x120e7af0;
inline constexpr std::array<ProtocolVirtualTarget, 22>
        kPacketSchemaWriterTargets{{
                {2, 0x0cbcf950, {0x20, 0x00, 0x80, 0x52, 0xc0, 0x03, 0x5f, 0xd6}},
                {3, 0x0cbcf958, {0xfd, 0x7b, 0xbf, 0xa9, 0xfd, 0x03, 0x00, 0x91}},
                {4, 0x0cbcf988, {0xfd, 0x7b, 0xbf, 0xa9, 0xfd, 0x03, 0x00, 0x91}},
                {5, 0x0cbcf9b8, {0xfd, 0x7b, 0xbf, 0xa9, 0xfd, 0x03, 0x00, 0x91}},
                {6, 0x0cbcf9e8, {0xfd, 0x7b, 0xbf, 0xa9, 0xfd, 0x03, 0x00, 0x91}},
                {7, 0x0cbcfa18, {0xfd, 0x7b, 0xbf, 0xa9, 0xfd, 0x03, 0x00, 0x91}},
                {8, 0x0cbcfa48, {0xfd, 0x7b, 0xbe, 0xa9, 0xf4, 0x4f, 0x01, 0xa9}},
                {9, 0x0cbcfac4, {0xfd, 0x7b, 0xbe, 0xa9, 0xf4, 0x4f, 0x01, 0xa9}},
                {10, 0x0cbcfb2c, {0xfd, 0x7b, 0xbe, 0xa9, 0xf4, 0x4f, 0x01, 0xa9}},
                {11, 0x0cbcfb94, {0xfd, 0x7b, 0xbe, 0xa9, 0xf4, 0x4f, 0x01, 0xa9}},
                {12, 0x0cbcfbfc, {0xfd, 0x7b, 0xbf, 0xa9, 0xfd, 0x03, 0x00, 0x91}},
                {13, 0x0cbcfc2c, {0xfd, 0x7b, 0xbf, 0xa9, 0xfd, 0x03, 0x00, 0x91}},
                {14, 0x0cbcfc5c, {0xfd, 0x7b, 0xbf, 0xa9, 0xfd, 0x03, 0x00, 0x91}},
                {15, 0x0cbcfc8c, {0xfd, 0x7b, 0xbd, 0xa9, 0xf5, 0x0b, 0x00, 0xf9}},
                {16, 0x0cbcfcf4, {0x00, 0x08, 0x40, 0xf9, 0x62, 0xb7, 0xfa, 0xb0}},
                {17, 0x0cbcfd10, {0xfd, 0x7b, 0xbe, 0xa9, 0xf4, 0x4f, 0x01, 0xa9}},
                {18, 0x0cbcfd70, {0x00, 0x08, 0x40, 0xf9, 0xc3, 0xba, 0xfa, 0x90}},
                {19, 0x0cbcfd8c, {0x20, 0x00, 0x80, 0x52, 0xc0, 0x03, 0x5f, 0xd6}},
                {20, 0x0cbcfd94, {0xc0, 0x03, 0x5f, 0xd6, 0x60, 0x00, 0x80, 0x52}},
                {21, 0x0cbcfd98, {0x60, 0x00, 0x80, 0x52, 0xc0, 0x03, 0x5f, 0xd6}},
                {22, 0x0cbcfda0, {0xc1, 0x02, 0x00, 0x36, 0xfd, 0x7b, 0xbe, 0xa9}},
                {23, 0x0cbcfe00, {0xc0, 0x03, 0x5f, 0xd6, 0xe8, 0x03, 0x01, 0xaa}},
        }};
...
inline constexpr std::uintptr_t kLevelChunkDispatcherOffset = 0x0c2bcbdc;
inline constexpr std::uintptr_t kLevelChunkDispatcherVtableSlotOffset = 0x120aaaa8;
...
inline constexpr std::uintptr_t kLevelRenderFrameOffset = 0x0ae0c130;
...
inline constexpr std::array<std::uint8_t, 16>
        kLevelRenderCameraPointerProbeSignature{
                0xc0, 0x0e, 0x40, 0xf9, 0x3d, 0xcf, 0x66, 0x95,
...
inline constexpr std::uintptr_t kLevelChunkVtableOffset = 0x1207e980;

inline constexpr std::uintptr_t kSubChunkDispatcherOffset = 0x0c2bf9fc;
inline constexpr std::uintptr_t kSubChunkDispatcherVtableSlotOffset = 0x120ae768;
...
inline constexpr std::uintptr_t kSubChunkVtableOffset = 0x120f46e8;
...
inline constexpr std::uintptr_t kLoopbackSendOffset = 0x0c2e279c;
inline constexpr std::uintptr_t kLoopbackSendVtableSlotOffset = 0x120b0c90;
...
inline constexpr std::uintptr_t kSubChunkRequestVtableOffset = 0x120f43c8;
...
inline constexpr std::uintptr_t kProjectionMatrixGetterOffset = 0x0a5d9e54;
...
inline constexpr std::uintptr_t kViewMatrixGetterOffset = 0x0a5d9e64;
...
inline constexpr std::uintptr_t kCameraPositionGetterOffset = 0x0a5d9e30;
...
// Actor::getLevel() at image offset 0x0ecad748 loads this exact member.
// Nearby code confirms that 0x1c8 belongs to a different actor field.
inline constexpr std::ptrdiff_t kActorLevelOffset = 0x1d0;
inline constexpr std::uintptr_t kActorGetLevelOffset = 0x0ecad748;
